            ...
            <form onSubmit={handleSubmit} className="space-y-5 bg-white p-8 rounded-[3rem] border border-brand-dark/5 shadow-2xl shadow-brand-dark/5">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-brand-cream border-none p-4 rounded-2xl focus:ring-1 focus:ring-brand-accent text-base md:text-xs transition-all appearance-none cursor-pointer"
                  >
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-brand-cream border-none p-4 rounded-2xl focus:ring-1 focus:ring-brand-accent text-base md:text-xs transition-all"
                />
              </div>
              <button
                type="submit"
